...
public class InventoryDataLocalService : IInventoryDataService
{
    ...
    public InventoryDataLocalService(HttpClient httpClient, ILocalStorageService localStorageService, NavigationManager navigationManager, IWebHostEnvironment webHostEnvironment)
    {
    ...
    {
        var items = new List<InventoryRecipe>
        {
            new InventoryRecipe
            {
